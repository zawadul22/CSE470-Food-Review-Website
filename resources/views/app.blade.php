        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ownerLoginView') }}">Switch to Owner Page</a>
                    </li>
                    @else
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('allReviews') }}">All Review</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('review') }}">Write Review</a>
                    </li>
                    <li class="nav-item">
